...
function AcaraKami() {
  return (
    <>
      <h1 className="judul" style={{ fontSize: "36px", marginBottom: "50px" }}>Acara Kami</h1>
      <div className="acara-container">
        <Link className="acara-card" to="/webinar">
          <img
            ...
            alt="webinar-icon"
          />
          <h1 style={{ fontSize: "24px"}}>Webinar</h1>
          <p>
        ...
        <Link className="acara-card" to="/workshop">
          <img
            ...
            alt="workshop-icon"
          />
          <h1 style={{ fontSize: "24px"}}>Workshop</h1>
          <p>
        ...
        <Link className="acara-card" to="/competition">
          ...
          <h1 style={{ fontSize: "24px"}}>Competition</h1>
          <p>
