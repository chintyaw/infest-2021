const questions = [
  ...
  },
  {
    ...
    info: <text>Pembayaran yang telah dilakukan tidak dapat di-refund dengan alasan apapun kecuali terjadi pembatalan acara dari pihak panitia</text>
  },
  {
    id: 4,
  ...
  {
    id: 5,
    title: 'Apakah mahasiswa baru angkatan 2021 dapat mendaftar trading competition?',
    info: <text>Untuk peserta yang merupakan mahasiswa baru angkatan 2021 bisa mendaftar dengan melampirkan bukti diterima pada universitas yg akan menjadi tempat berkuliah dalam waktu dekat ini.<br/><br/>Namun, peserta tetap diminta untuk melampirkan KTM yg dapat disusulkan di tengah2 perlombaan dengan mengirimkannya melalui CP yg tersedia. Apabila peserta tidak dapat mengirimkan KTM/KSM/Surat Keterangan Aktif Kuliah sampai batas di batas waktu yang ditentukan yaitu h-1 babak final, maka peserta akan di diskualifikasi.</text>
  },
  {
    id: 6,
