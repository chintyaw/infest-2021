const questions = [
  ...
  },
  {
    ...
    info: <text style={{fontSize:'18px'}}>Pembayaran yang telah dilakukan tidak dapat di-refund dengan alasan apapun kecuali terjadi pembatalan acara dari pihak panitia</text>
  },
  {
    id: 4,
    title: 'Apakah seluruh peserta Trading Competition akan mendapatkan sertifikat?',
    info:
      <text style={{fontSize:'18px'}}>Iya, seluruh peserta akan mendapat sertifikat</text>
  },
  {
    id: 5,
    title: 'Platform apa yang digunakan untuk Trading Competition?',
    info: <text style={{fontSize:'18px'}}>IDX</text>
  },
  {
    id: 6,
    title: 'Kapan dan di mana sertifikat diberikan?',
    info: <text style={{fontSize:'20px'}}>Seluruh sertifikat akan dibagikan melalui e-mail ketua tim masing-masing maksimal</text>
  },
]
