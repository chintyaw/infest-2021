...
const JudulInfest = () => {
    return (
        <div style={{ margin: "0", paddingTop: "180px", paddingBottom: "90px" }} className="Judul">
            ...
            <h1 style={{ textAlign: "center", marginLeft: "20px", marginRight: "20px" }} >The Biggest Investment Festival held<br/>by KSEP ITB for Indonesia</h1>
        </div>
    )
}

export default JudulInfest
